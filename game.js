...
class MenuScene extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.text(width/2,height/2+60,'PLAY',{
...
class SelectScene extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.image(width/2-220,height/2,'p1_idle')
            .setScale(1.2).setInteractive()
            .on('pointerdown',()=>this.scene.start('GameScene',{player:'player1'}));

        this.add.image(width/2+220,height/2,'p2_idle')
            .setScale(1.2).setInteractive()
...
class Enemy extends Phaser.Physics.Arcade.Sprite {
    ...
    die(){
        ...
        const h=this.scene.physics.add.image(this.x,this.y-20,'heart_small').setScale(0.4);
        h.setBounce(0.4).setCollideWorldBounds(true);
...
class GameScene extends Phaser.Scene {
    ...
    create(){
        ...
        this.bg=this.add.tileSprite(0,0,1248,832,'bg').setOrigin(0).setScrollFactor(0.3);
        ...
        for(let i=0;i<25;i++)
            this.hearts.create(Phaser.Math.Between(200,this.worldWidth-200),
