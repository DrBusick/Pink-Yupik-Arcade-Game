...
class GameScene extends Phaser.Scene {
    ...
    preload(){
        ...
        // UI кнопки для сенсорних екранів
    ...
    createMobileButtons(){
        const left=this.add.sprite(60,this.scale.height-60,'btn_left').setInteractive().setScrollFactor(0);
        const right=this.add.sprite(160,this.scale.height-60,'btn_right').setInteractive().setScrollFactor(0);
        const jump=this.add.sprite(this.scale.width-60,this.scale.height-60,'btn_jump').setInteractive().setScrollFactor(0);
